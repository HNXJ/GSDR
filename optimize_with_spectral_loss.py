...
from jbiophysic.models.optimizers import AGSDR
...
def run_optimization_spectral(
    ...
    # Create optimizer
    print("\n6. Creating AGSDR optimizer...")
    opt = AGSDR(learning_rate=5e-3, window=8, a=0.5, lam=0.05)
    ...
    for step in range(n_steps):
        ...
        updates, opt_state = opt.update(
            None, opt_state, params=params, value=loss, key=sub_rng
        )
